          ...
          <div className="flex items-center gap-4 relative">
            ...
            <div className="relative">
              <button 
                ...
                className={`w-9 h-9 rounded-full overflow-hidden border border-slate-200 focus:outline-none flex items-center justify-center text-white font-bold ${getAvatarBg(currentAdmin?.name || "AD")}`}
              >
        ...
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-[450px] bg-white shadow-2xl border-l border-slate-200 z-50 flex flex-col justify-between animate-in slide-in-from-right duration-350 select-none">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              {/* Profile Card */}
              <div className="flex flex-col items-center justify-center text-center">
                <div className={`w-20 h-20 rounded-full text-white flex items-center justify-center text-2xl font-bold mb-3 relative shadow-md ${getAvatarBg(currentAdmin.name)}`}>
