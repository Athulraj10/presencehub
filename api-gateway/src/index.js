...
// Env configurations matching your workspace path rules
...
// Import decoupled API router files matching your exact filenames
const employeeRouter = require('./routes/employeeRoutes');
const attendanceRouter = require('./routes/attendanceRoutes'); // Check spelling against your file
...
async function trackSystemHealth() {
  ...
  for (const srv of targets) {
    try {
      ...
      // Gracefully set to false instead of crashing the process
      activeServiceRegistry[srv.name] = false;
    }
  }

  // Self-scheduling loop: Safely schedules the next run 10 seconds after this check finishes
  setTimeout(trackSystemHealth, 10000);
}

// =========================================================
// 2. GATEKEEPER GUARD RAIL MIDDLEWARE
// =========================================================
...
// =========================================================
// 3. MOUNT ISOLATED FEATURE API ROUTERS
// =========================================================
...
// =========================================================
// 4. PUBLIC MONITORING ENDPOINTS (Kept in index.js)
// =========================================================
...
// =========================================================
// 5. MASTER INFRASTRUCTURE SPIN-UP ENGINE
// =========================================================
async function startGateway() {
  try {
    console.log("📂 Visual Studio working directory location:", process.cwd());

    // 1. Establish Railway MySQL Handshake
    ...
    // 2. Establish Cloud RabbitMQ Handshake
    ...
    // 3. Start the background health monitoring loops safely
    trackSystemHealth();

    // 4. Start listening for incoming traffic
    app.listen(PORT, () => {
